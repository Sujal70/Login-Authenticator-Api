...
namespace LT.UnitTest.MockRepos.Common
{
    ...
    public class MockUnitOfWork : IUnitOfWork
    {
        ...
        private IParentEmailSPRepo corpSettingsSPRepo;
        private ITokenRepo tokenRepo;
        private readonly CPortalContext _context = null;
        ...
        public IParentEmailSPRepo ParentEmailSPRepo { get { return corpSettingsSPRepo ??= new MockCorpSettingsSPRepo(); } }
